...
torch.multiprocessing.set_sharing_strategy('file_system') # <--- 添加这一行
device = "cuda:0" if torch.cuda.is_available() else "cpu"
path = os.path.dirname(os.path.realpath(__file__))

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--train', type=str, default="/home/gouqiaolin/model/G2Retro/data/bde_train/train_tensors_bde.pkl", help='data path to training data')
    parser.add_argument('--valid', type=str, default="/home/gouqiaolin/model/G2Retro/data/bde_train/filtered_valid.csv", help='data path to validation data')
    
    parser.add_argument('--vocab', type=str, default="/home/gouqiaolin/model/G2Retro/data/vocab.txt", help='data path to substructure vocabulary')
    parser.add_argument('--save_dir', type=str, default="/home/gouqiaolin/model/G2Retro/train_bde_result_3/", help='data path to the directory used to save trained models')
    ...
    for it, (batch, ie) in enumerate(tqdm(loader, desc="Training Epoch")):
